...
export default function Dashboard() {
  ...
  const navigation = [
    { name: "Dashboard", icon: HomeIcon, current: true, comp: <DashHome /> },
    {
      name: "Match STR",
    ...
    },
    {
      ...
      icon: CalendarIcon,
      current: false,
      comp: <Cases addNewCase={handleAddCase} />,
    },
    {
      name: "User",
      icon: UsersIcon,
      current: false,
      comp: <Users addNewUser={handleAddUser} />,
    },
    { name: "STR", icon: FolderIcon, current: false, comp: <Str /> },
    {
      name: "Officers",
      icon: ChartPieIcon,
      current: false,
      ...
      <div>
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                    <div className="flex h-16 shrink-0 items-center">
                      <img
                        ...
                        src={require("../assert/GenomeSync-Nexus-white.png")}
        ...
        <div className="lg:pl-72">
          ...
          <main className="py-10">
            <div className="px-4 sm:px-6 lg:px-8">{comp}</div>
          </main>
        </div>
      </div>
    </>
